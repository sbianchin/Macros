...
static double C2_intersect_SFT_top;
static double C2_intersect_SFT_bottom;
...
void Batch_Event_Display_Cosmic(Int_t Run_Number=5, Int_t ievt=0, Int_t ievt_max=0, Int_t enable_cout=9, Int_t display_fits = 0){ 
  ...
  int gap_to_fit_rotate = gap_to_fit;
  ...
  double Xloc_gap = 0;
  double Yloc_gap = 0;
  double xdistance1 = 999.;
  double ydistance1 = 999.;
  double xdistance2 = 999.;
  double ydistance2 = 999.;
  double xdistance3 = 999.;
  double ydistance3 = 999.;
  double xhyp1 = 999.;
  double xhyp2 = 999.;
  double xhyp3 = 999.;
  int closest_gap_point = 99;
  ...
  float x_int_TDC[2]={0};                        float y_int_TDC[2]={0};
  float x_int_TDC_selected[2]={0};               float y_int_TDC_selected[2]={0};
  float x_int_TDC_selected_weighted[2]={0};      float y_int_TDC_selected_weighted[2]={0};
  float x_int_GoodLG[2]={0};                     float y_int_GoodLG[2]={0};
  float x_int_GoodLG_weighted[2]={0};            float y_int_GoodLG_weighted[2]={0};
  float x_int_TDC_Gap_Fibers[2]={0};             float y_int_TDC_Gap_Fibers[2]={0};
  float x_int_TDC_SFT[2]={0};                    float y_int_TDC_SFT[2]={0};
  float x_int_GoodLG_SFT[2]={0};                 float y_int_GoodLG_SFT[2]={0};
  float x_int_TDC_Gap_Fibers_SFT[2]={0};         float y_int_TDC_Gap_Fibers_SFT[2]={0};
  float x_int_TARGET[2]={0};                     float y_int_TARGET[2]={0};
  ...
  float x_inter_SFT=0.;                      float y_inter_SFT=0.;     
  float x_inter_TOF1=0.;                     float y_inter_TOF1=0.;     
  ...
  double C2_gap_11_edge_1_x;
  double C2_gap_11_edge_2_x; 
  double C2_gap_11_edge_1_y;
  double C2_gap_11_edge_2_y;

  double C2_gap_5_edge_1_x; 
  double C2_gap_5_edge_2_x;
  double C2_gap_5_edge_1_y; 
  double C2_gap_5_edge_2_y; 

  double C2_gap_12_edge_1_x;
  double C2_gap_12_edge_2_x;
  double C2_gap_12_edge_1_y;
  double C2_gap_12_edge_2_y;

  double C2_gap_6_edge_1_x;
  double C2_gap_6_edge_2_x;
  double C2_gap_6_edge_1_y;
  double C2_gap_6_edge_2_y;

  double C2_gap_1_edge_1_x; 
  double C2_gap_1_edge_2_x; 
  double C2_gap_1_edge_1_y; 
  double C2_gap_1_edge_2_y; 

  double C2_gap_7_edge_1_x; 
  double C2_gap_7_edge_2_x; 
  double C2_gap_7_edge_1_y; 
  double C2_gap_7_edge_2_y; 

  double C2_gap_2_edge_1_x; 
  double C2_gap_2_edge_2_x; 
  double C2_gap_2_edge_1_y;
  double C2_gap_2_edge_2_y;

  double C2_gap_4_edge_1_x; 
  double C2_gap_4_edge_2_x; 
  double C2_gap_4_edge_1_y;
  double C2_gap_4_edge_2_y;  

  double C2_gap_8_edge_1_x; 
  double C2_gap_8_edge_2_x;
  double C2_gap_8_edge_1_y;  
  double C2_gap_8_edge_2_y;

  double C2_gap_10_edge_1_x;
  double C2_gap_10_edge_2_x; 
  double C2_gap_10_edge_1_y;
  double C2_gap_10_edge_2_y; 
  ...
  int ADC_High_TARGET_temp[256]={0};
  int ADC_Low_TARGET_temp[256]={0};
  int adc_low_target_temp[256]={0};
  bool has_TDC_hit_temp[256]={false};
  bool has_TDC_hit_Kstop_temp[256]={false};
  int HG_TARGET_ADC_Thr_temp[256]={0};
  int LG_TARGET_ADC_Thr_temp[256]={0};
  int TARGET_High_has_neighbours_temp[256]={0};
  bool k_stop_bar_temp[256]={false};

  double phi_top=999.99;
  double phi_bottom=999.99;

  double x1_C2_coord = 0.0;    double x1_C2_coord_global = 0.0;
  double x2_C2_coord = 0.0;    double x2_C2_coord_global = 0.0;
  double y1_C2_coord = 0.0;    double y1_C2_coord_global = 0.0;
  double y2_C2_coord = 0.0;    double y2_C2_coord_global = 0.0;

  double C2_angle=999.99;

  double C2_X1=0;   double C2_Y1=0;
  double C2_X2=0;   double C2_Y2=0;
  double tanalpha_C2=0.; double alpha_C2=999.99; 
  double angle_C2=999.99;

  vector<double> vec_output_ana3;
 ...
 /////////////////////////////////////////////////////////////////////////////////////////////////////
  ...
  char output[100];
  sprintf(output,"RUN_%d_TEST.dat",Run_Number);
  ofstream fout;
  fout.open(output);

  for(int ivt=ievt; ivt<ievt_max+1; ivt++){   // LOOP OVER EVENTS !!!
    
    for(int init=0; init<256; init++){
      has_TDC_hit[init] = false;
      has_TDC_hit_Kstop[init] = false;
      k_stop_bar[init] = false;
    }

    for(int init=0; init<128; init++) has_TDC_SFT_hit[init] = false;
    ...
    //for(int i=0; i<256; i++) cout << "ADC_HIGH: " << ivt << "   " << i << "   " << TDC_LE_TARGET[i] << endl;
    ...
    for(int init=0; init<12; init++){
      Good_tof1[init] = false;
      Good_tof2[init] = false;
    }
    ...
    //********* GOOD TOF EVENTS
    for(int init=0; init<12; init++){
    Good_TOF1_ADC[init]=false;   
    Good_TOF1_TDC[init]=false;   
    Good_TOF1[init]=false;       
    Good_TOFs[init]=false;
    Good_TOF2_ADC[init]=false;    
    Good_TOF2_TDC[init]=false;
    Good_TOF2[init]=false;
    }
...
//    if(Good_Event) cout << "Event: "<< ivt << "   --  GOOD EVENT!" << endl;

    if(Good_TARGET_Event && Good_TOF_Event && !Good_MWPC_Event){
      cout << "Event: "<< ivt << "   --  NO MWPC!" << endl;
      cout << " " << endl;
...
//      continue;
    ...
    if(Good_TARGET_Event && !Good_TOF_Event && !Good_MWPC_Event){
      cout << "Event: "<< ivt << "   --  NO TOF and NO MWPC!" << endl;
      cout << " " << endl;
      cout << ">>>>>  Please, choose another event" << endl;
      cout << " " << endl;
//      break;
//      continue;
    ...
    if(!Good_TARGET_Event && Good_TOF_Event && !Good_MWPC_Event){
      cout << "Event: "<< ivt << "   --  NO TARGET and NO MWPC!" << endl;
      cout << " " << endl;
      cout << ">>>>>  Please, choose another event" << endl;
      cout << " " << endl;
//      break;
//      continue;
    ...
    if(!Good_TARGET_Event && !Good_TOF_Event && Good_MWPC_Event){
      cout << "Event: "<< ivt << "   --  NO TARGET and NO TOF!" << endl;
      cout << " " << endl;
      cout << ">>>>>  Please, choose another event" << endl;
      cout << " " << endl;
//      break;
//      continue;
    ...
    if(!Good_TARGET_Event && !Good_TOF_Event && !Good_MWPC_Event){
      cout << "Event: "<< ivt << "   --  NO TARGET and NO TOF and NO MWPC!" << endl;
      cout << " " << endl;
      cout << ">>>>>  Please, choose another event" << endl;
      cout << " " << endl;
//      break;
...
//  if(!Good_Event) continue;
  ...
  for(int init=0; init<12; init++){
    has_ADC_TOF1_hit[init] = false;
    has_TDC_TOF1_hit[init] = false;
    has_ADC_TOF2_hit[init] = false;
    has_TDC_TOF2_hit[init] = false;
    has_both_ADC_TOF1_hit[init] = false; 
  }
...
//  cout << "DEBUG : " << gap_to_fit_left << "   " << gap_to_fit_right << endl;
...
//  cout << "XXXXX : " << gap_to_fit_right << endl;
...
//  cout << "DEB: " << gap_to_fit_left << "   " << tie_count << endl;   OK !
  ...
  //cout << "Event: " << ivt << endl;
  //cout << "TEST:   LEFT: " << gap_to_fit_left << endl;
  //cout << "        RIGHT: " << gap_to_fit_right << endl;


  for(int init=0; init<12; init++){
    gap_hit[init] = 0;
    ADC_TOF1_hit[init] = 0;
    ADCTDC_TOF1_hit[init] = 0;
    ADC_TOF2_hit[init] = 0;
    ADCTDC_TOF2_hit[init] = 0;
    gap_counter[init] = 0;
  ...
  for(int init=0; init<256; init++){
    TARGET_High_has_neighbours[init] = false;
    //for(int j=0; j<8; j++){
    //  TARGET_neighbours[init][j] = false;
    //}
  }
  ...
  for(int i = 0; i<256; i++){
    //iseb2++;
    //cout << iseb2 << "  " << i << "  " << TARGET_High_has_neighbours[i] << endl;
    for(int j=0; j<8; j++){
      //if((TARGET_neighbours[i][j] != -1 && ADC_High_TARGET[TARGET_neighbours[i][j]] >= Angle_ADC_cut)){
        if((TARGET_neighbours[i][j] != -1 && ADC_High_TARGET[TARGET_neighbours[i][j]] >= Angle_ADC_cut && has_TDC_hit[TARGET_neighbours[i][j]] && !k_stop_bar[TARGET_neighbours[i][j]]) ||
         ...
         iseb2++;
         //cout << "TEST: " << iseb2 << "   " << i << "   " << TARGET_neighbours[i][j] << endl;
           break;
      }
    }
  }
  ...
  //cout << "TOTAL : " << ivt << "  " << h_TDC_Gap_Fibers->GetEntries() << endl;
  //cout << "Event " << ivt << "  x_inc = " << x_inc << "  y_inc = " << y_inc << "  " << hit_count << endl;
 ...
 */
  ...
  for(int init2=0; init2<56; init2++){
    C2X_L[init2] = 0;
    C2X_R[init2] = 0;
  }
    for(int init3=0; init3<64; init3++){
    C3X_L[init3] = 0;
    C3X_R[init3] = 0;
  }
  for(int init4=0; init4<72; init4++){
    C4X_L[init4] = 0;
    C4X_R[init4] = 0;
  }
  ...
  */
  ...
  C2X_L_cluster_index.clear(); // Hold the starting index of each cluster.
  C2X_L_cluster_length.clear(); // Hold the length of each cluster.
  C2Y_L_cluster_index.clear();
  C2Y_L_cluster_length.clear();

  C3X_L_cluster_index.clear();
  C3X_L_cluster_length.clear();
  C3Y_L_cluster_index.clear();
  C3Y_L_cluster_length.clear();    

  C4X_L_cluster_index.clear();
  C4X_L_cluster_length.clear();  
  C4Y_L_cluster_index.clear();
  C4Y_L_cluster_length.clear();  



  C2X_R_cluster_index.clear(); // Hold the starting index of each cluster.
  C2X_R_cluster_length.clear(); // Hold the length of each cluster.
  C2Y_R_cluster_index.clear();
  C2Y_R_cluster_length.clear();

  C3X_R_cluster_index.clear();
  C3X_R_cluster_length.clear();
  C3Y_R_cluster_index.clear();
  C3Y_R_cluster_length.clear();    

  C4X_R_cluster_index.clear();
  C4X_R_cluster_length.clear();  
  C4Y_R_cluster_index.clear();
  C4Y_R_cluster_length.clear();   
  ...
  for(unsigned int i=0; i<good_k_stop_bars.size(); i++){
  ...
  */
  ...
  if((gap_to_fit==12 || gap_to_fit==6) && Rotate==1){   
    for(int init=0; init<256; init++){ 
      ADC_High_TARGET_temp[init]={0};
      ADC_Low_TARGET_temp[init]={0};
      adc_low_target_temp[init]={0};
      has_TDC_hit_temp[init]={false};
      has_TDC_hit_Kstop_temp[init]={false};
      HG_TARGET_ADC_Thr_temp[init]={0};
      LG_TARGET_ADC_Thr_temp[init]={0};
      TARGET_High_has_neighbours_temp[init]={0};
      k_stop_bar_temp[init]={false};
    }

    //for(int i=0; i<256; i++){
    //  cout << "DEBUG: " << i << "  " << has_TDC_hit_temp[i] << "  " << has_TDC_hit_Kstop_temp[i] << "  " << k_stop_bar_temp[i] << endl;
    //}
  ...
  //cout << "Event: " << ivt << endl;
  //cout << "xdist1: " << xdistance1 << "   ydist1: " << ydistance1 << "   xhyp1:  " << xhyp1 << endl;
  //cout << "xdist2: " << xdistance2 << "   ydist2: " << ydistance2 << "   xhyp2:  " << xhyp2 << endl;
  //cout << "xdist3: " << xdistance3 << "   ydist3: " << ydistance3 << "   xhyp3:  " << xhyp3 << endl;
  ...
  //cout << "has_data_ADC3 : " << has_data_ADC3 << endl;

  if (has_data_ADC3 > 1){
    double xcoord = 0;
    Int_t unique_x = 0;

    //cout << "has_data_ADCA : " << has_data_ADCA << endl;
...
`   */
    ...
    //c2->cd(6);
    //h_TDC_selected->Draw();
    h_TDC_selected->Fit("pol1", "QCM");   // ??? Qcm !!!
  ...
  //cout << "DEBUG : " << a_fit_TDC_Gap_Fibers << "  " << b_fit_TDC_Gap_Fibers << "  " << R_TOF1 << endl;
  ...
  if(h_TDC_Gap_Fibers->GetEntries() != 0){
    ...
    for(int init=0; init<2; init++){
      x_int_TDC[init]=0.;                        y_int_TDC[init]=0.;
      x_int_TDC_selected[init]=0.;               y_int_TDC_selected[init]=0.;
      x_int_TDC_selected_weighted[init]=0.;      y_int_TDC_selected_weighted[init]=0.;
      x_int_GoodLG[init]=0.;                     y_int_GoodLG[init]=0.;
      x_int_GoodLG_weighted[init]=0.;            y_int_GoodLG_weighted[init]=0.;
      x_int_TDC_Gap_Fibers[init]=0.;             y_int_TDC_Gap_Fibers[init]=0.;
      x_int_TDC_SFT[init]=0.;                    y_int_TDC_SFT[init]=0.;
      x_int_GoodLG_SFT[init]=0.;                 y_int_GoodLG_SFT[init]=0.;
      x_int_TDC_Gap_Fibers_SFT[init]=0.;         y_int_TDC_Gap_Fibers_SFT[init]=0.;
      x_int_TARGET[init]=0.;                     y_int_TARGET[init]=0.;
    }
    ...
    //cout << "DEBUG1: " << x_int_TDC_Gap_Fibers[1] << "  " << x_TDC_Gap_Fibers_intersect1 << endl;
    ...
    for(int i=0; i<2; i++){
      dist1_TDC_selected[i]=999.;
      dist1_GoodLG[i]=999.;
      dist1_TDC_Gap_Fibers[i]=999.;
      dist1_TDC_Gap_Fibers_SFT[i]=999.;
    }
        //cout << "DEBU2: " << x_int_TDC_Gap_Fibers[1] << "  " << x_TDC_Gap_Fibers_intersect1 << endl;
  ...
  for(int i = 0; i<3; i++)
    ...
    //cout << "DEBUG: " << x_int_TDC_Gap_Fibers[1] << "  " << x_TDC_Gap_Fibers_intersect1 << endl;
...
//      cout << "DEBUG: " << x_int_TDC_Gap_Fibers[1] << "  " << x_TDC_Gap_Fibers_intersect1 << endl;
    ...
    for(int i=0; i<2; i++){
      dist1_TDC_selected_weighted[i]=999.;
      dist1_TDC_SFT[i]=999.;
      dist1_GoodLG_weighted[i]=999.;
      dist1_GoodLG_SFT[i]=999.;
      dist1_TARGET_intersect[i]=999.;
    }
  ...
  if((gap_to_fit_rotate==12 || gap_to_fit_rotate==6) && Rotate==1){
    ...
    //cout << "SEB: "<< gap_to_fit_rotate << "  " << angle_final_guide << endl;
    ...
    if((gap_to_fit_rotate==6 || gap_to_fit_rotate==12) && Rotate==1){
      x_inter_SFT = -y_TDC_Gap_Fibers_SFT_intersect1;
      y_inter_SFT = x_TDC_Gap_Fibers_SFT_intersect1;
      x_inter_TOF1 = -y_TDC_Gap_Fibers_intersect1;
      y_inter_TOF1 = x_TDC_Gap_Fibers_intersect1;
      //cout << "Intersect with SFT Layer 1:  " << "x = " << x_inter_SFT << "   " << "y = " << y_inter_SFT << endl;
      //cout << "Intersect with TOF1:  " << "x = " << x_inter_TOF1 << "   " << "y = " << y_inter_TOF1 << endl;
    }
    else{
      x_inter_SFT = x_TDC_Gap_Fibers_SFT_intersect1;
      y_inter_SFT = y_TDC_Gap_Fibers_SFT_intersect1;
      x_inter_TOF1 = x_TDC_Gap_Fibers_intersect1;
      y_inter_TOF1 = y_TDC_Gap_Fibers_intersect1;    
      //cout << "Intersect with SFT Layer 1:  " << "x = " << x_inter_SFT << "   " << "y = " << y_inter_SFT << endl;
      //cout << "Intersect with TOF1:  " << "x = " << x_inter_TOF1 << "   " << "y = " << y_inter_TOF1 << endl;  
  }
    //cout << "" << endl;
  ...
  */
    ...
    target_slope = 0;
    c2_centroid_slope = 0.0;
    c2_centroid_int = 0.0;
    selected_C2L_index = 0;
    selected_C2R_index = 0;
    x1_rotated = 0;
    y1_rotated = 0;
    x2_rotated = 0;
    y2_rotated = 0;      
    x1_rotated_selected = 0;
    y1_rotated_selected = 0;
    x2_rotated_selected = 0;
    y2_rotated_selected = 0;    
    min_slope_difference = 10000000.0;

    //cout << "SEB:  " << x1_rotated_selected << endl;
    ...
    //cout << "DEBUG5: " << gap_to_fit_left << "  " << gap_to_fit_right << endl;

    if(gap_to_fit_left!=0 && gap_to_fit_right!=0){

      for(int i = 0; i < max_length; i++){
        //  cout << "DEB: " << i << "  " << C2Y_L_centroids[i] << endl;
        if(C2Y_L_centroids[i] < -5000)
          break;

        for(int j = 0; j < max_length; j++){
          //cout << "FFF: " << C2Y_R_centroids[j] << endl;
          if(C2Y_R_centroids[j] < -5000)
            break;

          //cout << "SEB: " << c2_centroid_slope << "  " << target_slope << "  " << min_slope_difference << endl;
          //cout << "HERE" << endl;
          ...
          if(gap_to_fit_left==12 && gap_to_fit_right==6){
            ...
            x2_rotated = rotate_by_angle(C2Y_R_centroids[j],629.4,90,'x'); //!
            y2_rotated = rotate_by_angle(C2Y_R_centroids[j],629.4,90,'y');  //!
            ...
            //cout << "DEBUG4: " << c2_centroid_slope << "  " << target_slope << "  " << min_slope_difference << endl;
            if(fabs(c2_centroid_slope - target_slope) < min_slope_difference){
              ...
              //cout << " DEBUG3: " << x1_rotated_selected << "  " << y1_rotated_selected << endl;
              //cout << " DEBUG4: " << x2_rotated_selected << "  " << y2_rotated_selected << endl;
         }
    ...
    //TLine *C2_line;
      C2_X1 = 0.;    C2_Y1 = 0.;
      C2_X2 = 0.;    C2_Y2 = 0.;
      tanalpha_C2 = 0.;   alpha_C2 = 999.99;
      angle_C2 = 999.99;

    //cout << "min_slope_difference:  " << min_slope_difference << endl;
    ...
    if(min_slope_difference != 10000000.0){
      ...
      C2_X1 = -50;   C2_Y1 = c2_centroid_slope*(-50.0) + c2_centroid_int;
      C2_X2 = 50;    C2_Y2 = c2_centroid_slope*(50.0) + c2_centroid_int;
    }
    //cout << "==> " << C2_X1 << "  " << C2_Y1 << endl;
    //cout << "==> " << C2_X2 << "  " << C2_Y2 << endl;
    //cout << "TEST: " << x1_rotated_selected << endl;

    //cout << "DEBUG1: " << c2_centroid_slope << "  " << c2_centroid_int << endl;

    tanalpha_C2 = (C2_Y2-C2_Y1)/(C2_X2-C2_X1);
    alpha_C2 = atan(tanalpha_C2);
    if(c2_centroid_slope<0) angle_C2 = -alpha_C2*(180/PI);
    else angle_C2 = alpha_C2*(180/PI);
    //if(min_slope_difference = 10000000.) angle_C2 = 999.999;

    //cout << "DEBUG: " << tanalpha_C2 << "  " << alpha_C2 << endl;
    //cout << "ALPHA : " << angle_C2 << endl;

    if((gap_to_fit_left==11 && gap_to_fit_right==5) || (gap_to_fit_left==10 && gap_to_fit_right==4)){
      angle_C2 = 180-angle_C2;
    }

    //cout << "TEST: " << C2X_L_centroids[0] << "  " << C2X_R_centroids[0] << endl;
    //cout << "TEST: " << C2Y_L_centroids[0] << "  " << C2Y_R_centroids[0] << endl;
  
    if(C2X_L_centroids[0]<-5000 || C2X_R_centroids[0]<-5000 || C2Y_L_centroids[0]<-5000 || C2Y_R_centroids[0]<-5000){
      angle_C2 = 999.99;
    }

    //cout << "DEBUG: " << C2_X1 << "  " << C2_Y1 << endl;
    //cout << "DEBUG: " << C2_X2 << "  " << C2_Y2 << endl;
    //cout << "DEBUG: " << tanalpha_C2 << endl;
    //cout << " ==> C2 DEBUG: " << angle_C2 << endl;
  ...
  */
  ...
  C2_gap_11_edge_1_x = rotate_by_angle(-80.0, 629.4, 30, 'x');
  C2_gap_11_edge_2_x = rotate_by_angle(80.0, 629.4, 30, 'x'); 
  C2_gap_11_edge_1_y = rotate_by_angle(-80.0, 629.4, 30, 'y');
  C2_gap_11_edge_2_y = rotate_by_angle(80.0, 629.4, 30, 'y');

  C2_gap_5_edge_1_x = rotate_by_angle(-80.0, 629.4, -150, 'x'); 
  C2_gap_5_edge_2_x = rotate_by_angle(80.0, 629.4, -150, 'x');
  C2_gap_5_edge_1_y = rotate_by_angle(-80.0, 629.4, -150, 'y'); 
  C2_gap_5_edge_2_y = rotate_by_angle(80.0, 629.4, -150, 'y'); 

  C2_gap_12_edge_1_x = rotate_by_angle(-80.0, 629.4, 0, 'x');
  C2_gap_12_edge_2_x = rotate_by_angle(80.0, 629.4, 0, 'x');
  C2_gap_12_edge_1_y = rotate_by_angle(-80.0, 629.4, 0, 'y');
  C2_gap_12_edge_2_y = rotate_by_angle(80.0, 629.4, 0, 'y');

  C2_gap_6_edge_1_x = rotate_by_angle(-80.0, 629.4, 180, 'x');
  C2_gap_6_edge_2_x = rotate_by_angle(80.0, 629.4, 180, 'x');
  C2_gap_6_edge_1_y = rotate_by_angle(-80.0, 629.4, 180, 'y');
  C2_gap_6_edge_2_y = rotate_by_angle(80.0, 629.4, 180, 'y');

  C2_gap_1_edge_1_x = rotate_by_angle(-80.0, 629.4, -30, 'x'); 
  C2_gap_1_edge_2_x = rotate_by_angle(80.0, 629.4, -30, 'x'); 
  C2_gap_1_edge_1_y = rotate_by_angle(-80.0, 629.4, -30, 'y'); 
  C2_gap_1_edge_2_y = rotate_by_angle(80.0, 629.4, -30, 'y'); 

  C2_gap_7_edge_1_x = rotate_by_angle(-80.0, 629.4, 150, 'x'); 
  C2_gap_7_edge_2_x = rotate_by_angle(80.0, 629.4, 150, 'x'); 
  C2_gap_7_edge_1_y = rotate_by_angle(-80.0, 629.4, 150, 'y'); 
  C2_gap_7_edge_2_y = rotate_by_angle(80.0, 629.4, 150, 'y'); 

  C2_gap_2_edge_1_x = rotate_by_angle(-80.0, 629.4, -60, 'x'); 
  C2_gap_2_edge_2_x = rotate_by_angle(80.0, 629.4, -60, 'x'); 
  C2_gap_2_edge_1_y = rotate_by_angle(-80.0, 629.4, -60, 'y');
  C2_gap_2_edge_2_y = rotate_by_angle(80.0, 629.4, -60, 'y');

  C2_gap_4_edge_1_x = rotate_by_angle(-80.0, 629.4, -120, 'x'); 
  C2_gap_4_edge_2_x = rotate_by_angle(80.0, 629.4, -120, 'x'); 
  C2_gap_4_edge_1_y = rotate_by_angle(-80.0, 629.4, -120, 'y');
  C2_gap_4_edge_2_y = rotate_by_angle(80.0, 629.4, -120, 'y');  

  C2_gap_8_edge_1_x = rotate_by_angle(-80.0, 629.4, 120, 'x'); 
  C2_gap_8_edge_2_x = rotate_by_angle(80.0, 629.4, 120, 'x');
  C2_gap_8_edge_1_y = rotate_by_angle(-80.0, 629.4, 120, 'y');  
  C2_gap_8_edge_2_y = rotate_by_angle(80.0, 629.4, 120, 'y');

  C2_gap_10_edge_1_x = rotate_by_angle(-80.0, 629.4, 60, 'x');
  C2_gap_10_edge_2_x = rotate_by_angle(80.0, 629.4, 60, 'x'); 
  C2_gap_10_edge_1_y = rotate_by_angle(-80.0, 629.4, 60, 'y');
  C2_gap_10_edge_2_y = rotate_by_angle(80.0, 629.4, 60, 'y'); 
  ...
  */
  ...
  //cout << "TESST :  " << gap_to_fit_right << "  " << c2xl_num_lines << "   " << c2xr_num_lines << endl;
  ...
  for(int i = 0; i < c2xl_num_lines; i++){
    for(int j = 0; j < c2xr_num_lines; j++){
      ...
      x1_C2_coord = 0.0;    x1_C2_coord_global = 0.0;
      x2_C2_coord = 0.0;    x2_C2_coord_global = 0.0;
      y1_C2_coord = 0.0;    y1_C2_coord_global = 0.0;
      y2_C2_coord = 0.0;    y2_C2_coord_global = 0.0;
     ...
     if(x1_C2_coord == x2_C2_coord){
      ...
      //cout << "DEBUG1: " << x1_C2_coord << "  " << y1_C2_coord << endl;
      //cout << "DEBUG1: " << x2_C2_coord << "  " << y2_C2_coord << endl;
    }
  }    

  //if(c2xl_num_lines==0 || c2xr_num_lines==0){
  //  C2_intersect_SFT_top = 999.;
  //  C2_intersect_SFT_bottom = 999.;
  //}

  //cout << "UUUUUU  :  " << C2_intersect_SFT_top << "  " << C2_intersect_SFT_bottom << endl;
  ...
  if((gap_to_fit_left>=7 && gap_to_fit_left<=12) && (gap_to_fit_right>=1 && gap_to_fit_right<=6)){
    if(angle_final_guide > 180){
      phi_top = angle_final_guide-180;
      phi_bottom = angle_final_guide; 
    }
    else{
      phi_top = angle_final_guide;
      phi_bottom = angle_final_guide+180;
    }
  }

  //SFT_angle_selector(Run_Number,ievt,angle_final_guide, gap_to_fit_left, gap_to_fit_right);
  vec_output_ana3.clear();

  //for(int i=0; i<128; i++){
  //  if(ADC_High_SFT_corr[i]!=0 && has_TDC_SFT_hit[i]) cout << "DEBUG99:  " << ivt << "  " << i << "  " << ADC_High_SFT_corr[i] << endl;
  //}
  ...
  if(ivt%1000==0) cout << ivt << " events done! "<< endl;

  if(ana_flag == 1){
    if(gap_to_fit_left!=9 && (gap_to_fit_left-gap_to_fit_right==6) && angle_C2<999.99){
      if(x_inter_SFT!=0. && y_inter_SFT!=0.){
        vec_output_ana3 = Batch_Ana3(Run_Number, ivt, ADC_High_SFT_corr, has_TDC_SFT_hit, SFT_channel_to_fiber, angle_final_guide, gap_to_fit_left, gap_to_fit_right, C2_intersect_SFT_top, C2_intersect_SFT_bottom);
        //cout << "#########################################################" << endl;
        
        printf("%4d  %6d  %2d  %2d %6.2f  %7.2f  %6.2f  %6.2f  %7.2f  %7.2f  %7.2f  %7.2f  %7.2f  %7.2f  %7.2f  %7.2f  %7.2f  %7.2f  %7.2f  %7.2f\n",
          Run_Number, ivt, gap_to_fit_left, gap_to_fit_right,
          angle_final_guide, phi_top, phi_bottom, angle_C2,
          x_inter_SFT, y_inter_SFT, x_inter_TOF1, y_inter_TOF1,
          C2_intersect_SFT_top, C2_intersect_SFT_bottom,
          vec_output_ana3[0], vec_output_ana3[1], vec_output_ana3[2], vec_output_ana3[3],
          0.5*(double(TDC_TOF1U[gap_to_fit_left-1])-double(TDC_TOF1D[gap_to_fit_left-1])),
          0.5*(double(TDC_TOF1U[gap_to_fit_right-1])-double(TDC_TOF1D[gap_to_fit_right-1])));
        
        //cout << "TOF1U_left =  " << TDC_TOF1U[gap_to_fit_left-1] << "   " << double(TDC_TOF1U[gap_to_fit_left-1]) << endl;
        //cout << "TOF1D_left =  " << TDC_TOF1D[gap_to_fit_left-1] << "   " << double(TDC_TOF1D[gap_to_fit_left-1]) << endl;
        //cout << "TOF1U_right =  " << TDC_TOF1U[gap_to_fit_right-1] << "   " << double(TDC_TOF1U[gap_to_fit_right-1]) << endl;
        //cout << "TOF1D_right =  " << TDC_TOF1D[gap_to_fit_right-1] << "   " << double(TDC_TOF1D[gap_to_fit_right-1]) << endl;
        //cout << endl;
        //cout << endl;


        fout << Run_Number << "  " << ivt << "  " << gap_to_fit_left << "  " << gap_to_fit_right << "  "
             << angle_final_guide << "  " << phi_top << "  " << phi_bottom << "  " << angle_C2 << "  "
             << x_inter_SFT << "  " << y_inter_SFT << "  " << x_inter_TOF1 << "  " << y_inter_TOF1 << "  " 
             << C2_intersect_SFT_top << "  " << C2_intersect_SFT_bottom << "  "
             << vec_output_ana3[0] << "  " << vec_output_ana3[1] << "  " << vec_output_ana3[2] << "  " << vec_output_ana3[3] << "  "
      ...
      //cout << endl;
      //cout << endl;
      //Ana3(Run_Number, ivt, ADC_High_SFT_corr, has_TDC_SFT_hit, SFT_channel_to_fiber, angle_final_guide, gap_to_fit_left, gap_to_fit_right, C2_intersect_SFT_top, C2_intersect_SFT_bottom);
    }
  }

    //cout << "DEBUG1: " << vec_output_ana3[0] << endl;
  ...
  //cout << "DDDD : " << h_TDC_Gap_Fibers->GetEntries() << endl;
