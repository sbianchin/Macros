...
//char file_batch[100] = "Keito_run_3994_1.txt";

//char file_batch[100] = "kekcc_500_7_evt.txt";
//char file_batch[100] = "kekcc_500_8_evt.txt";
char file_batch[100] = "kekcc_all_merged_78_evt.txt";
//char file_batch[100] = "kekcc_all_7_evt.txt";
//char file_batch[100] = "kekcc_all_8_evt.txt";

//char batch_output[100] = "kekcc_500_7_output.txt";
//char batch_output[100] = "kekcc_500_8_output.txt";
//char batch_output[100] = "kekcc_all_7_output.txt";
//char batch_output[100] = "kekcc_all_8_output.txt";
...
vector<double> Z_selected;
  ...
  bool Good_TOF1_intersect = false;
  ...
  //double HG_TARGET_ADC_Thr[256] = {0};
  //double LG_TARGET_ADC_Thr[256] = {0};
  //double HG_SFT_ADC_Thr[128] = {0};
  //double LG_SFT_ADC_Thr[128] = {0};

  Int_t TDC_min_SFT;
  Int_t TDC_max_SFT;

  bool TARGET_High_has_neighbours[256] = {false};
  bool kaon_has_neighbours[256] = {false};
  ...
  vector <double> vec_xx_lepton_pr;
  vector <double> vec_yy_lepton_pr;
  vector <double> vec_ex_lepton_pr;
  vector <double> vec_ey_lepton_pr;
  ...
  vector<double> vec_kaon_xx_rotate;
  vector<double> vec_kaon_yy_rotate;
  vector<double> vec_kaon_ex_rotate;
  vector<double> vec_kaon_ey_rotate;
  vector<int> barn_kaon_rotate;
  ...
  double xx_int_TDC_TARGET;
  double yy_int_TDC_TARGET;
  ...
  double x_int_TOF1[2];                          double y_int_TOF1[2];
  ...
  float dist2_TDC_selected[5];
  float dist2_GoodLG[5];
  ...
  double x_TOF1_intersect=0;                      double y_TOF1_intersect=0;
  double x_Arrows=0;                              double y_Arrows=0;

  double dist1_TARGET_intersect[2];
  double dist1_TOF1_intersect[2];
  ...
  double xx_kaon_centroid_coordinates;
  double yy_kaon_centroid_coordinates;

  vector<double> vec_fit_lines_intersect;
  double xx_fit_lines_intersect;
  double yy_fit_lines_intersect;

  double xx_kstop_final;
  double yy_kstop_final;
  double R_Kstop = -1.;
