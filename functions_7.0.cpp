...
int select_kaon(bool display=false){
  ...
  if(vec_candidates.size()==0){
    ...
    if(display){
      ...
      printf("Kaon 1st Max. :   %4d    %4d     %4d    %4d\n",kaon_max1, ADC_High_TARGET[kaon_max1], max1, TDC_max1);
      printf("Kaon 2nd Max. :    ---    ----     ----    ----\n");
   ...
   for(unsigned int i=0; i<vec_candidates.size(); i++){
    ...
    //else if(TDC_max1 > TDC_max2) TDC_output = TDC_max1;
    //else if(TDC_max1 < TDC_max2) TDC_output = TDC_max2;
    ...
    if(display){
      ...
      printf("                  Fiber  ADC(HG)  ADC(LG)   TDC\n");
      printf("Kaon 1st Max. :   %4d    %4d     %4d    %4d\n",kaon_max1, ADC_High_TARGET[kaon_max1], max1, TDC_max1);
      printf("Kaon 2nd Max. :   %4d    %4d     %4d    %4d\n",kaon_max2, ADC_High_TARGET[kaon_max2], max2, TDC_max2);
      printf("TDC Average   :  %4d\n",TDC_output);
      cout << endl;
    }
  }  
