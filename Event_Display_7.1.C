...
void Event_Display(int Run_Number=3994, int ievt=0, int enable_cout=0, int Switch_Printout = 1,
  ...
  char Version[100] = "Version 7.1";  // TO MOVE
...
*/
  ...
  for(int k=0; k<weight_TOF1_fit1; k++){
    vec_xx_lepton.push_back(TOF1_Xloc[gap_to_fit-1][1]);
    vec_ex_lepton.push_back(TOF1_Errors_X[gap_to_fit-1][1]);
  
    vec_yy_lepton.push_back(TOF1_Yloc[gap_to_fit-1][1]);
...
/*  cout << "ALAN SIZE : " << vec_kaon_bars.size() << endl;
    cout << "AAAA" <<
    if(kaon_substitute>0 && vec_kaon_bars.size()==0){
      cout << "ALALALALALALA  " << endl;
    }
*/
  if(To_rotate){
    ...
    for(int k=0; k<weight_TOF1_fit1; k++){
      vec_xx_lepton_rotated.push_back(TOF1_Xloc[TOF1_rotated[gap_to_fit-1]][1]);
      vec_ex_lepton_rotated.push_back(TOF1_Errors_X[TOF1_rotated[gap_to_fit-1]][1]);
  
      vec_yy_lepton_rotated.push_back(TOF1_Yloc[TOF1_rotated[gap_to_fit-1]][1]);
      vec_ey_lepton_rotated.push_back(TOF1_Errors_Y[TOF1_rotated[gap_to_fit-1]][1]);
    }
  ...
  */
  ...
  //NEW
  vec_xx_pruning_area = _pruning_area(vec_xx_kstop_0[0], TOF1_Xloc[TOF1_neighbours[0]][1], TOF1_Xloc[TOF1_neighbours[1]][1]);
  vec_yy_pruning_area = _pruning_area(vec_yy_kstop_0[0], TOF1_Yloc[TOF1_neighbours[0]][1], TOF1_Yloc[TOF1_neighbours[1]][1]);
...
*/
  ...
  perp_distance = sqrt(pow((TOF1_Xloc[gap_to_fit-1][1]-vec_intersect_prr[0]),2) + 
    pow((TOF1_Yloc[gap_to_fit-1][1]-vec_intersect_prr[1]),2));

  double X_pink, Y_pink;
  X_pink = TOF1_Xloc[gap_to_fit-1][1] + (perp_distance-6)*cos(60*PI/180);
  Y_pink = TOF1_Yloc[gap_to_fit-1][1] - (perp_distance-6)*sin(60*PI/180);
