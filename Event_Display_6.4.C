...
#include "TMarker.h"
#include "ANAPATH.h"
#include "../Macros/CommonParameters_old.h"
...
void Event_Display(int Run_Number=3994, int ievt=0, int enable_cout=0, int Switch_Printout = 1,
  ...
  char Version[100] = "Version 6.4";  // TO MOVE
  ...
  //// GAP SCORING !
    ...
    cout << "8 : " << gap_counter[7] << endl;
    cout << "9 : " << gap_counter[8] << endl;
  ...
  if(Switch_Printout != 0){
    ...
    if(gap_to_fit==6 || gap_to_fit==12){
      ...
      cerr << endl;
      // change to gap_to_fit rather tha gap -1  mh Dec 22
