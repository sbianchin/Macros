...
void Event_Display(int Run_Number=3994, int ievt=0, int enable_cout=0, int Switch_Printout = 1,
  ...
  char Version[100] = "Version 7.0";  // TO MOVE
...
*/
  ...
  /// NEW WAY 
  TDC_average_NEW = select_kaon(false);
...
*/
  ...
  //cout << "SIZE : " << vec_lepton_bars_pruned.size() << endl;

  //vec_xx_lepton.push_back(Xloc[vec_lepton_bars_pruned[0]]);
  //vec_yy_lepton.push_back(Yloc[vec_lepton_bars_pruned[0]]);
  //vec_ex_lepton.push_back(TARGET_Errors_X);
  //vec_ey_lepton.push_back(TARGET_Errors_Y);
  //cerr << Xloc[vec_lepton_bars_pruned[12]] << "   " << Xloc[vec_lepton_bars_pruned[12]] << endl;
  //cerr << vec_lepton_bars_pruned[12] << endl;
  //cerr << vec_lepton_bars_pruned[13] << endl;
  //cerr << vec_lepton_bars_pruned[14] << endl;
  //cerr << vec_lepton_bars_pruned[15] << endl;
  //cerr << vec_lepton_bars_pruned[16] << endl;

  //cerr << Xloc[vec_lepton_bars_pruned[13]] << "   " << Xloc[vec_lepton_bars_pruned[13]] << endl;

  //for(unsigned int i=0; i<vec_lepton_bars.size(); i++){
  for(unsigned int i=0; i<vec_lepton_bars_pruned.size(); i++){
    //cerr << i << "  " << Xloc[vec_lepton_bars_pruned[i]] << endl;
...
/*  else{
    //cout << "2222" << "    " << vec_xx_lepton_pruned.size() << endl;
    if(batch==1){
